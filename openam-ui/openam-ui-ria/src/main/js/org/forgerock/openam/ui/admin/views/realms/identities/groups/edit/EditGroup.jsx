...
class EditGroup extends Component {
    handleMembersSave = (membersData) => {
        ...
        // TODO: we probably need to send members under "uniqueMember" property, e.g.:
        // "uniqueMember": [
        //     "uid=test1,ou=people,dc=openam,dc=forgerock,dc=org",
        //     "uid=test2,ou=people,dc=openam,dc=forgerock,dc=org"
        // ],
        // https://backstage.forgerock.com/docs/am/7.4/setup-guide/sec-rest-realm-rest.html#rest-api-add-user-to-group
        // "member" is used in AD implementations
        // "members" - not sure where this is used
    ...
    handlePrivilegesSave = (privilegesData) => {
        ...
        // TODO: we probably don't support this, privileges are not part of the group returned by /groups API
